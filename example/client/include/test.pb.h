...
inline void LoginResponse::set_code(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Test.LoginResponse.code)
}
...
inline const std::string& LoginResponse::msg() const {
  // @@protoc_insertion_point(field_get:Test.LoginResponse.msg)
...
void LoginResponse::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Test.LoginResponse.msg)
}
inline std::string* LoginResponse::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:Test.LoginResponse.msg)
  return _s;
}
...
inline std::string* LoginResponse::release_msg() {
  // @@protoc_insertion_point(field_release:Test.LoginResponse.msg)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Test.LoginResponse.msg)
}
