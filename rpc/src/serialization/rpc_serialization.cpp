...
bool rpc_serialization::serialize(const std::string & service_name,
...
bool rpc_serialization::deserialize(const std::string & in_buffer,
...
bool rpc_serialization::deserialize_args(const std::string & in_buffer, google::protobuf::Message * args)
{
