...
#ifndef GOOGLE_PROTOBUF_INCLUDED_serialization_2frpc_5fheader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_serialization_2frpc_5fheader_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_serialization_2frpc_5fheader_2eproto
...
struct TableStruct_serialization_2frpc_5fheader_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_serialization_2frpc_5fheader_2eproto;
namespace WW {
class RpcHeader;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::WW::RpcHeader* Arena::CreateMaybeMessage<::WW::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace WW {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:WW.RpcHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:WW.RpcHeader)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_serialization_2frpc_5fheader_2eproto;
};
// ===================================================================
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:WW.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:WW.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:WW.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:WW.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:WW.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:WW.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:WW.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:WW.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:WW.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:WW.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:WW.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:WW.RpcHeader.args_size)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_serialization_2frpc_5fheader_2eproto
